            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{ route('home') }}"><img
                                class="main__logo--img" src="{{ asset('assets/img/logo/nav-log2.png') }}"
                                alt="logo-img"></a></h1>
                </div>
...
`                            </li>
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{ route('blog') }}">Blog
                                </a>
                            </li>
                            <li class="header__menu--items">
                        ...
                        <li class="language__currency--list">
                            <a class="offcanvas__language--switcher" href="#">
                                <img class="language__switcher--icon__img"
                                     src="{{ asset('assets/img/icon/language-icon.png') }}"
                                     alt="currency">
                                <span>English</span>
                   ...
                   data-offcanvas="">
                        <span class="offcanvas__stikcy--toolbar__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewbox="0 0 512 512"><path
                                    ...
                                    fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path
                                    fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10"
                                    stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                        </span>
                   ...
                   data-offcanvas="">
                        <span class="offcanvas__stikcy--toolbar__icon">
                            ...
                            <path
                                ...
                                transform="translate(-62.393 -135.3)" fill="currentColor"></path>
                            </svg>
                        </span>
                ...
                <a class="offcanvas__stikcy--toolbar__btn" href="wishlist.html">
                        <span class="offcanvas__stikcy--toolbar__icon">
                            ...
                            <path
                                ...
                                transform="translate(-62.498 -132.915)" fill="currentColor"></path>
                            </svg>
                        </span>
